...
public class GeojsonToImageUtils {
     ...
     * @return
     */
    private static String readGeoJsonFile(String jsonPath) {
        // 读文件到Stringbuffer
    ...
    public static void main(String[] args) throws IOException {
        ...
        String iamgepath="C:\\Users\\JGS\\Desktop\\1\\";//生成图片文件路径【不需要文件名称】
//        String geojson = ParsingShpFileUtils.shape2Geojson(shpPath, geojsonPath);

        String geojson = readGeoJsonFile("C:\\Users\\JGS\\Desktop\\test.json");
